import Postal from '@atech/postal';
 ...
 async function MailChaoMung(dataMail) {
try {
  ...
  message.subject(`🔓 [OnThiTHPT] Mở khóa thành công! Em có 1 tin nhắn mới từ hệ thống AI...`);
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <p>Chào mừng bạn đã trở thành thành viên chính thức của Smart AI Guide</p>
        </div>
        
        <!-- Main Content -->
        <div class="content">
            <p class="salutation">Xin chào ${dataMail.name},<br><br>
            Chúc mừng bạn đã đăng ký tài khoản thành công tại Smart AI Guide! Dưới đây là thông tin quan trọng về tài khoản của bạn:</p>
            
            <div class="document-box">
                <div class="exclusive-badge">THÔNG TIN TÀI KHOẢN</div>
                <div class="document-title">Chào mừng đến với cộng đồng Smart AI Guide</div>
                
                <p class="document-description">
                    Cảm ơn bạn đã tin tưởng và lựa chọn chúng tôi làm người đồng hành trong hành trình học tập. 
                    Bạn giờ đây có thể truy cập toàn bộ tài nguyên học tập độc quyền dành riêng cho thành viên.
                </p>
                
                <div class="features">
                    <div class="feature-item">
                        <span class="feature-icon">✓</span>
                        <span class="feature-text">Truy cập ngay vào hệ thống học tập thông minh</span>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">✓</span>
                        <span class="feature-text">Nhận tài liệu học tập cá nhân hóa mỗi tuần</span>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">✓</span>
                        <span class="feature-text">Tham gia cộng đồng học sinh xuất sắc</span>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">✓</span>
                        <span class="feature-text">Được hỗ trợ 24/7 từ đội ngũ giáo viên</span>
                    </div>
                </div>
            </div>
            ...
            <div class="download-section">
                <a href="https://onthithpt2026.com/" class="download-btn">
                    <span>🚀</span>
                    <span>TRUY CẬP TÀI KHOẢN NGAY</span>
                </a>
                <p class="download-note">(Liên kết đăng nhập sẽ được gửi kèm trong email này. Vui lòng không chia sẻ với người khác)</p>
            </div>
            
            <p style="margin-top: 32px; font-size: 15px; color: #4b5563;">
                <strong>Lưu ý quan trọng:</strong><br>
                • Kiểm tra email thường xuyên để nhận tài liệu học tập mới nhất<br>
                • Tham gia nhóm Zalo học tập để được hỗ trợ nhanh nhất<br>
                • Liên hệ hotline 1900 1059 nếu cần bất kỳ trợ giúp nào
            </p>
        </div>
    ...
    <div class="course-body">
        ...
        <a href="#" class="course-link">ĐĂNG KÝ NGAY</a>
    </div>
</div>
...
<div class="course-card">
    ...
    <div class="course-body">
        ...
        <div class="footer">
            ...
            <p class="copyright">© 2026 📚 Smart AI Guide . Mọi quyền được bảo lưu.</p>
