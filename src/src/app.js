...
app.post("/api/TaiLieu2k8Auto", async (req, res) => {
  try {
    ...
    const checkEmail = await Dataemail.findOne({ email: item.email })
    
      if (!checkEmail) {


        if (item.monhoc.indexOf("Toán") != -1) {
          ...
          console.log("Môn Toán :", item.email)

        }
        if (item.monhoc.indexOf("Văn") != -1) {
          ...
          console.log("Môn Văn :", item.email)

        }

        if (item.monhoc.indexOf("Ngoại ngữ") != -1) {
          ...
          console.log("Môn Ngoại Ngữ :", item.email)
        }

        if (item.monhoc.indexOf("Lịch sử") != -1) {
          console.log("Lịch Sử")
          await Lichsu.create({
            name: item.name,
            email: item.email,
          ...
          console.log("Môn Lịch Sử :", item.email)

        }

        if (item.monhoc.indexOf("Vật lý") != -1) {
          console.log("Vật Lý")
          await Vatly.create({
            name: item.name,
            email: item.email,
          ...
          console.log("Môn Vật Lý :", item.email)

        }


        if (item.monhoc.indexOf("Sinh Học") != -1) {
          ...
          console.log("Môn Sinh Học :", item.email)

        }

        if (item.monhoc.indexOf("Địa Lý") != -1) {
          console.log("Địa Lý")
          await Dialy.create({
            name: item.name,
            email: item.email,
          ...
          console.log("Môn Địa Lý :", item.email)

        }


        if (item.monhoc.indexOf("Giáo dục kinh tế và pháp luật") != -1) {
          console.log("Giáo dục kinh tế và pháp luật")
          ...
          console.log("Môn Giáo dục kinh tế và pháp luật :", item.email)

        }

        if (item.monhoc.indexOf("Tin học") != -1) {
          console.log("tin hoc")
          await Tinhoc.create({
            name: item.name,
            email: item.email,
          ...
          console.log("Môn Tin Học :", item.email)

        }

        if (item.monhoc.indexOf("Hóa học") != -1) {
          console.log("Hóa học")
          await Hoahoc.create({
            name: item.name,
            email: item.email,
          ...
          console.log("Môn Hóa học :", item.email)

        }


        if (item.monhoc.indexOf("Công Nghệ") != -1) {
          console.log("Cong Nghe")
          ...
          console.log("Môn Công Nghệ :", item.email)
        ...
        res.status(200).json({ message: "Chúc bạn đăng kí thành công, thư sẽ sớm gửi tới bạn và muộn nhất là 24h sau" });
